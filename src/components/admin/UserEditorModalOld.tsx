...
export function UserEditorModalOld({
  user,
  onClose,
  onSave,
  onUserUpdated,
              ...
              <div style={imageStyles.zonesRow}>
                ...
                >
                  <div style={imageStyles.zoneHeader}>
                    ...
                    {avatarImg.via !== "none" && (
                      <span style={imageStyles.badge}>{avatarImg.via}</span>
                    )}
                  </div>
                  <div
                  ...
                  >
                    {avatarImg.preview ? (
                      <img
                        ...
                        alt="Avatar preview"
                        style={imageStyles.previewImg}
                        draggable={false}
                      />
                    ) : (
                      <div style={imageStyles.emptyMsg}>
                        <span>
                          {avatarMediaId
                            ? "Loading…"
                ...
                >
                  <div style={imageStyles.zoneHeader}>
                    ...
                    {bgImg.via !== "none" && (
                      <span style={imageStyles.badge}>{bgImg.via}</span>
                    )}
                  </div>
                  <div
                ...
                <div style={{ flex: 1 }}>
                  {imagesMsg && (
                    <div
                      style={{
                        fontSize: ".65rem",
                        color: imagesMsg.toLowerCase().includes("success")
                          ? "#6fe39e"
                          : "#ffb3b3",
                      }}
                    >
                ...
                <div style={{ flex: 1 }}>
                  {saveMsg && (
                    <div
                      style={{
                        fontSize: ".65rem",
                        color: saveMsg.startsWith("Successfully")
                          ? "#6fe39e"
                          : "#ffb3b3",
                        paddingLeft: 2,
                      }}
