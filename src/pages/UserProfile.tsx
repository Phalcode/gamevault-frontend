            ...
            {bookmarks.length > 0 ? (
              bookmarks.map((game) => {
                ...
                return (
                  ...
                  >
                    <div className="surface-panel rounded-3xl p-3 transition-[transform,translate,scale,box-shadow,border-color] duration-200 ease-out hover:-translate-y-1 hover:border-gv-line-strong hover:shadow-(--shadow-shell)">
                      <GamePoster
                        game={game}
                        title={title}
                        width={126}
