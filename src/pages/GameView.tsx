          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="w-56 md:w-64 shrink-0">
              {coverId ? (
                ...
                <div className="w-full aspect-[3/4] flex items-center justify-center rounded-xl bg-zinc-200 dark:bg-zinc-800 text-xs text-fg-muted">
                  No Cover
                </div>
              )}
            </div>
            <div className="flex-1 min-w-0 space-y-4">
              ...
              {description ? (
                ...
                <p className="text-sm italic text-fg-muted/70">
