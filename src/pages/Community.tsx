  ...
  return showProfile ? (
    ...
    <div className="flex min-h-full flex-col gap-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-2">
          ...
          <Text className="max-w-2xl">
            Browse the people in your vault network, check who was active recently,
            and jump directly into each profile.
          </Text>
        </div>
      ...
      {loadingDetails && members.length > 0 && (
        <div className="text-sm text-gv-muted">Refreshing player activity…</div>
      )}
    </div>
  );
}