...
// Numeric enum matching backend PERMISSION_ROLE
...
export function normalizePermissionRole(value: any): PermissionRole | null {
  ...
  switch (s) {
    case '0':
    case 'GUEST': return PermissionRole.GUEST
    case '1':
    case 'USER': return PermissionRole.USER
    case '2':
    case 'EDITOR': return PermissionRole.EDITOR
    case '3':
    case 'ADMIN': return PermissionRole.ADMIN
    default: return null
  }
}
...
export interface User {
  ...
  Progresses?: Progress[] | null
  // Canonical role numeric enum (backend sends an int)
